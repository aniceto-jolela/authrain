...
urlpatterns = [
    ...
    path('security/delete/', views.delete_authenticated_user_dj, name='delete_authenticated_user_dj'),
    path('delete_user_confirm_dj/', views.delete_user_confirm_dj, name='delete_user_confirm_dj'),
